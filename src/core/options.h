...
#define RADIOVERSION "2026.03.29" // Currently in the process of cleaning-up files... see code-issues.md for more info...

/*******************************************************
THIS FILE IS THE DEFINITIVE HANDLER OF COMPILE OPTIONS.
It contains many notes and options and examples that may
be used in myoptions.h when compiling. DO NOT EDIT THIS FILE.
...
to build your own and contribute your own example!
********************************************************/
