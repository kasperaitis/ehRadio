...
#define RADIOVERSION "2026.02.12"
...
#endif
/* Battery dim fixed brightness when LOW battery (percentage 0-100). */
#ifndef BATTERY_DIM_BRIGHTNESS
  #define BATTERY_DIM_BRIGHTNESS 20
#endif
/* Hysteresis for recovering from low-battery dimming (percent). */
#ifndef BATTERY_RECOVER_HYSTERESIS_PCT
  #define BATTERY_RECOVER_HYSTERESIS_PCT 5
#endif
