...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 osjećaj: %.1f\011C \007 pritisak: %d hPa \007 vlažnost: %s%% \007 vjetar: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 pritisak: %d hPa \007 vlažnost: %s%%";
#endif
