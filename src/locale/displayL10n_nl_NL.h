...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 gevoel: %.1f\011C \007 druk: %d hPa \007 vocht: %s%% \007 wind: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 druk: %d hPa \007 vocht: %s%%";
#endif
