...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 føles som: %.1f\011C \007 tryk: %d hPa \007 fugtighed: %s%% \007 vind: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 tryk: %d hPa \007 fugtighed: %s%%";
#endif
const char     weatherUnits[]    PROGMEM = "metric";
const char      weatherLang[]    PROGMEM = "da";       /* https://openweathermap.org/current#multi */
