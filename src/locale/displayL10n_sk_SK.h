...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 pocitovo: %.1f\011C \007 tlak: %d hPa \007 vlhkosť: %s%% \007 vietor: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 tlak: %d hPa \007 vlhkosť: %s%%";
#endif
