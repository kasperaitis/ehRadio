...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 sensação: %.1f\011C \007 pressão: %d hPa \007 humidade: %s%% \007 vento: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 pressão: %d hPa \007 humidade: %s%%";
#endif
