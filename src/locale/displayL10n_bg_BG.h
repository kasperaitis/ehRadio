...
const char octt[] PROGMEM = "Октомври";
const char nov[] PROGMEM = "Ноември";
const char decc[] PROGMEM = "Декември";
...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 усеща се като: %.1f\011C \007 налягане: %d гПа \007 влажност: %s%% \007 вятър: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 налягане: %d гПа \007 влажност: %s%%";
#endif
const char     weatherUnits[]    PROGMEM = "metric";
const char      weatherLang[]    PROGMEM = "bg";       /* https://openweathermap.org/current#multi */
