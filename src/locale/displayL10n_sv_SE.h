...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 känns som: %.1f\011C \007 tryck: %d hPa \007 luftfuktighet: %s%% \007 vind: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 tryck: %d hPa \007 luftfuktighet: %s%%";
#endif
const char     weatherUnits[]    PROGMEM = "metric";   /* standard, metric, imperial */
const char      weatherLang[]    PROGMEM = "sv";       /* https://openweathermap.org/current#multi */
