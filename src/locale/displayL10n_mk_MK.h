...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 осеќање: %.1f\011C \007 притисок: %d гПа \007 влажност: %s%% \007 ветер: %.1f m/s [%s]";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 притисок: %d гПа \007 влажност: %s%%";
#endif
const char     weatherUnits[]    PROGMEM = "metric";   /* standard, metric, imperial */
const char      weatherLang[]    PROGMEM = "mk";       /* https://openweathermap.org/current#multi */
